...
var swagger_1 = require("./documentation/swagger");
...
// Register endpoint
exports.app.post("/api/user/signup", function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                userData = req.body;
                user = new schema_1.User(userData);
            ...
            case 1:
                ...
                return [4 /*yield*/, bcrypt_1.default.hash(userData.password, 12)];
            case 2:
...
// Login endpoint
exports.app.post("/api/user/login", function (req, resp) {
    ...
    schema_1.User.findOne({ email: userData.email })
        ...
        var token = jsonwebtoken_1.default.sign(payload, "".concat(process.env.SECRET_KEY));
...
exports.app.get('/api/user/:userId', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                try {
                    // Verify the token
                    payload = jsonwebtoken_1.default.verify(token, "".concat(process.env.SECRET_KEY));
                }
                catch (error) {
                    return [2 /*return*/, resp.status(401).send("Unauthorized")];
                }
                ...
                return [4 /*yield*/, schema_1.User.findById(userId)];
            case 2:
                user = _a.sent();
                if (!user) {
...
// update user profile
exports.app.put('/api/user/:userId', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, schema_1.User.findByIdAndUpdate(userId, userData, { new: true })];
            case 2:
                updatedUser = _a.sent();
                if (!updatedUser) {
                    return [2 /*return*/, resp.status(404).json({ message: 'User not found' })];
...
exports.app.post('/wallet', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.app.post('/wallet/credit', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, schema_1.Transaction.create(transaction)];
            case 3:
                _a.sent();
...
exports.app.post('/wallet/debit', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var token, payload, userId, wallet, _a, amount, walletAccountNumber, receiver, tr, transaction, error_6;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, schema_1.Wallet.findOne({ walletAccountNumber: walletAccountNumber })];
            case 2:
                receiver = _b.sent();
                if (!receiver) {
                    return [2 /*return*/, resp.status(404).json({ error: 'Wallet not found' })];
            ...
            case 3:
                ...
                return [4 /*yield*/, schema_1.Transaction.create(tr)];
            case 4:
                _b.sent();
                // Update wallet balance
                wallet.balance -= amount;
            ...
            case 7:
                error_6 = _b.sent();
                console.error('Error crediting wallet:', error_6);
                resp.status(500).json({ error: 'An unexpected error occurred' });
                return [3 /*break*/, 8];
...
exports.app.post('/api/transaction/send', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, senderId, receiverId, amount, receiverAccountNumber, token, payload, userId, wallet, receiver, transaction, tr, error_7;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, senderId = _a.senderId, receiverId = _a.receiverId, amount = _a.amount, receiverAccountNumber = _a.receiverAccountNumber;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 8, , 9]);
                // Check if the authorization header is missing
            ...
            case 2:
                ...
                return [4 /*yield*/, schema_1.Wallet.findOne({ walletAccountNumber: receiverAccountNumber })];
            case 3:
                receiver = _b.sent();
                if (!receiver) {
            ...
            case 5:
                _b.sent();
                transaction = new schema_1.Transaction({
            ...
            case 8:
                error_7 = _b.sent();
                console.error('Error sending funds:', error_7);
                resp.status(500).json({ message: 'Internal server error' });
                return [3 /*break*/, 9];
...
exports.app.post('/api/users/:userId/wallet/withdraw', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var amount, token, payload, userId, wallet, error_8;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                amount = req.body.amount;
            ...
            case 4:
                error_8 = _a.sent();
                console.error('Error withdrawing funds:', error_8);
                resp.status(500).json({ message: 'Internal server error' });
                return [3 /*break*/, 5];
            case 5: return [2 /*return*/];
        }
...
exports.app.get('/api/users/:userId/wallet/transactions', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, token, payload, userId_1, transactions, error_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = req.params.userId;
            ...
            case 1:
                ...
                userId_1 = payload.subject;
                return [4 /*yield*/, schema_1.Transaction.find({
                        $or: [{ senderId: userId_1 }, { receiverId: userId_1 }],
                    }).sort({ timestamp: -1 })];
            case 2:
            ...
            case 3:
                error_9 = _a.sent();
                console.error('Error fetching wallet transactions:', error_9);
                resp.status(500).json({ message: 'Internal server error' });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
